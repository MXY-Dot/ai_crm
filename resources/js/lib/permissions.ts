...
const MANAGER_PLUS: DashboardPage[] = ['ai', 'knowledge', 'analytics', 'integrations', 'marketplace', 'team', 'booking-settings', 'catalog-settings', 'restaurant-settings', 'hotel-settings'];
