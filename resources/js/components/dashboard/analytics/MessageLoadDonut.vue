    ...
    <div class="flex flex-col rounded-xl border p-5" style="border-color: var(--border); background: var(--card)">
        ...
        <div class="mt-6 space-y-2 text-sm">
            <div class="flex items-center justify-between">
                <span class="flex items-center gap-2 ui-text"><span class="h-3 w-3 rounded-full" style="background: var(--primary)" />AI Ассистент</span>
                <span class="font-mono ui-subtle">{{ groups.ai }}</span>
            </div>
            <div class="flex items-center justify-between">
                <span class="flex items-center gap-2 ui-text"><span class="h-3 w-3 rounded-full" style="background: var(--muted-foreground)" />Операторы</span>
