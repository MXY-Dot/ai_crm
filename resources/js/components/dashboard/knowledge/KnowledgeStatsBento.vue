...
<template>
    <div class="grid gap-4 md:grid-cols-3">
        ...
        <div class="relative overflow-hidden rounded-xl border p-5" style="border-color: var(--primary); background: var(--card)">
            <div class="pointer-events-none absolute right-0 top-0 h-16 w-16 rounded-bl-full" style="background: color-mix(in srgb, var(--primary) 12%, transparent)" />
            <div class="mb-2 flex items-center justify-between">
