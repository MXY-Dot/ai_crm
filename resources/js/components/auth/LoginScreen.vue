...
<template>
    <main class="dark relative flex min-h-screen items-center justify-center overflow-hidden bg-zinc-950 px-4 py-10 text-zinc-100">
        ...
        <div class="relative grid w-full max-w-5xl gap-10 lg:grid-cols-[1fr_420px] lg:items-center">
            ...
            <Card class="relative border-white/10 bg-zinc-900/70 shadow-2xl shadow-black/40 backdrop-blur-xl" :title="isRegister ? 'Начать пробный период' : 'С возвращением'" :subtitle="isRegister ? `Выбранный тариф: ${plan}` : 'Войдите через email и пароль.'">
