...
const props = defineProps</* @vue-ignore */ContextMenuCheckboxItemProps & { class?: HTMLAttributes['class'] }>()
const emits = defineEmits</* @vue-ignore */ContextMenuCheckboxItemEmits>()
