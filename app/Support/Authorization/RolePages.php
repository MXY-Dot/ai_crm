...
class RolePages
{
    ...
    public const MANAGER_PLUS = ['ai', 'ai.agent', 'knowledge', 'analytics', 'integrations', 'marketplace', 'team', 'booking-settings', 'catalog-settings', 'restaurant-settings', 'hotel-settings', 'auto-service-settings', 'education-settings', 'travel-settings'];
