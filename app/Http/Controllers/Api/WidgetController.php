 ...
 * all. Instead every request carries a `siteKey` (the `channels.external_id`
 * of the tenant's single `provider = 'website'` channel, generated by
 * WidgetSettingsController) which is the sole tenant-resolution mechanism —
 * treat it like a public, non-secret app id (same trust model as Intercom's
 * `app_id` or Crisp's website id: it's visible in page source by design).
 */
